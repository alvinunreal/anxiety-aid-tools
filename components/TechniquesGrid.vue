  ...
  <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
    ...
    >
      ...
      <div class="flex flex-col items-center text-center">
        ...
        <p class="text-gray-600 dark:text-slate-300 text-sm mb-3 leading-relaxed" :id="`technique-${technique.id}-description`">{{ $t(`techniques.${technique.id}.short_description`) }}</p>
